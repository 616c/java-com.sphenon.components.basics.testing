...
public class VectorImplList_DataSource_Pair_String_Test__long_
  implements Vector_Pair_String_Test__long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Pair_String_Test__long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Pair_String_Test__long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Pair_String_Test__long_(context, vector_source);
    }

    public Pair_String_Test_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_String_Test_) vector_source.get(context).get((int) index);
