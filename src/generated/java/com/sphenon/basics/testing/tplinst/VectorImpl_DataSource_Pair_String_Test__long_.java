...
public class VectorImpl_DataSource_Pair_String_Test__long_
  implements Vector_Pair_String_Test__long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Pair_String_Test__long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Pair_String_Test__long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Pair_String_Test__long_(context, vector_source);
    }

    public Pair_String_Test_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Pair_String_Test_) vector_source.get(context).elementAt((int) index);
    ...
    public Pair_String_Test_ set          (CallContext context, long index, Pair_String_Test_ item) {
        ...
        return (Pair_String_Test_) vector_source.get(context).set((int) index, item);
    }
    ...
    public Pair_String_Test_ unset        (CallContext context, long index) {
        try {
            return (Pair_String_Test_) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
