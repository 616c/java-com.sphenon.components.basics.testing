...
public class VectorReferenceToMember_Test_long_
    implements ReferenceToMember_Test_long_ReadOnlyVector_Test_long__
{
    private ReadOnlyVector_Test_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Test_long_ (CallContext context, ReadOnlyVector_Test_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public Test get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Test_long_)) return false;
        if (((VectorReferenceToMember_Test_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Test_long_) object).index  != this.index ) return false;
        return true;
    }
