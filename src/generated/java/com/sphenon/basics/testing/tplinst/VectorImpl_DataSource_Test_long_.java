...
public class VectorImpl_DataSource_Test_long_
  implements Vector_Test_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Test_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Test_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Test_long_(context, vector_source);
    }

    public Test get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Test) vector_source.get(context).elementAt((int) index);
    ...
    public Test set          (CallContext context, long index, Test item) {
        ...
        return (Test) vector_source.get(context).set((int) index, item);
    }
    ...
    public Test unset        (CallContext context, long index) {
        try {
            return (Test) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
